...
public abstract class Email {
	 ...
	 *             {@link EmailConstants#MAIL_SMTP_SOCKET_FACTORY_FALLBACK}
	 *             instead
	 */
	@Deprecated
	...
	/**
	 * @deprecated since 1.3, use
	 *             {@link EmailConstants#MAIL_SMTP_CONNECTIONTIMEOUT} instead
	 */
	@Deprecated
	...
	/**
	 * Set the charset of the message. Please note that you should set the
	 * charset before adding the message content.
	 *
	 * @param newCharset
	 *            A String.
	 ...
	 *             if no support for the named charset exists in the current JVM
	 * @since 1.0
	 */
	...
	/**
	 * Set or disable the STARTTLS encryption. Please see EMAIL-105 for the
	 * reasons of deprecation.
	 *
	 * @deprecated since 1.3, use setStartTLSEnabled() instead
	 * @param withTLS
	 *            true if STARTTLS requested, false otherwise
	 * @since 1.1
	 */
	@Deprecated
	...
	/**
	 * Supply a mail Session object to use. Please note that passing a user name
	 * and password (in the case of mail authentication) will create a new mail
	 * session with a DefaultAuthenticator. This is a convenience but might come
	 * unexpected.
	 *
	 ...
	 *
	 * @param jndiName
	 *            name of JNDI resource (javax.mail.Session type), resource if
	 *            searched in java:comp/env if name does not start with "java:"
	 * @throws IllegalArgumentException
	 *             if the JNDI name is null or empty
	 * @throws NamingException
	 *             if the resource cannot be retrieved from JNDI directory
	 * @since 1.1
	 */
	 ...
	 * Session if necessary. When a mail session is already initialized setting
	 * the session related properties will cause an IllegalStateException.
	 *
	 * @return A Session.
	 * @throws EmailException
	 *             if the host name was not set
	 * @since 1.0
	 */
	 ...
	 * be used as the personal names. The names will be encoded by the charset
	 * of {@link #setCharset(java.lang.String) setCharset()}. If it is not set,
	 * it will be encoded using the Java platform's default charset (UTF-16) if
	 ...
	 *
	 * @param aCollection
	 *            collection of <code>InternetAddress</code> objects.
	 * @return An Email.
	 * @throws EmailException
	 *             Indicates an invalid email address.
	...
	/**
	 * Add an array of CC recipients to the email. The email addresses will also
	 * be used as the personal name. The names will be encoded by the charset of
	 * {@link #setCharset(java.lang.String) setCharset()}. If it is not set, it
	 * will be encoded using the Java platform's default charset (UTF-16) if it
	 * contains non-ASCII characters; otherwise, it is used as is.
	 *
	 ...
	 * will also be used as the personal name. The names will be encoded by the
	 * charset of {@link #setCharset(java.lang.String) setCharset()}. If it is
	 * not set, it will be encoded using the Java platform's default charset
	 * (UTF-16) if it contains non-ASCII characters; otherwise, it is used as
	 * is.
	 *
	 * @param emails
	 *            A String array.
	 ...
	 *            A Map.
	 * @throws IllegalArgumentException
	 *             if either of the provided header / value is null or empty
	 * @since 1.0
	 */
	 ...
	 * @since 1.0
	 * @throws IllegalArgumentException
	 *             if either {@code name} or {@code value} is null or empty
	 */
	 ...
	 *             when the mail session is already initialized
	 * @since 1.0
	 */
	 ...
	 * user rarely calls this method directly and only if he/she is interested
	 * in the sending the underlying MimeMessage without commons-email.
	 *
	 * @throws IllegalStateException
	 *             if the MimeMessage was already built
	 * @throws EmailException
	...
	//tanvirirfan.utsa adding this method as a replacement of Mock
	public String sendMimeMessage(boolean b) {
		EmailUtils.notNull(this.message, "MimeMessage has not been created yet");
		try {
			return this.message.getMessageID();
	 ...
	 * @return the message id of the underlying MimeMessage
	 * @throws IllegalStateException
	 *             if the MimeMessage was already built, ie
	...
	public String send() throws EmailException {
		...
		return this.sendMimeMessage(true);
	}
	 ...
	 *            Whether or not to log into pop3 server before sending mail.
	 * @param newPopHost
	...
	/**
	 * Sets whether SSL/TLS encryption should be enabled for the SMTP transport
	 * upon connection (SMTPS/POPS). See EMAIL-105 for reason of deprecation.
	 *
	 * @deprecated since 1.3, use setSSLOnConnect() instead
	 * @param ssl
	 ...
	 *            whether to enable server identity check
	 * @return An Email.
	 * @since 1.3
	 */
	 ...
	 *
	 * @param sslSmtpPort
	 *            the SSL port to use for the SMTP transport
	 */
	 ...
	 * {@link #send()} may throw a {@link javax.mail.SendFailedException}, even
	 * if partial send mode is enabled (emails to valid addresses will be
	 * transmitted). In case the email server does not reject invalid addresses
	 * immediately, but return a bounce message, no exception will be thrown by
	 * the {@link #send()} method.
	 *
	 * @param sendPartial
	 *            whether to enable partial send mode
	 * @return An Email.
	 * @since 1.3.2
	 */
	 ...
	 * @throws IllegalArgumentException
	 *             if either the name or value is null or empty
	 */
	 ...
	 *            A name.
	 * @param charsetName
	 *            The name of the charset to encode the name with.
	 * @return An internet address.
	 * @throws EmailException
	 *             Thrown when the supplied address, name or charset were
	 *             invalid.
	 */
	 ...
	 * has no effect. In order to flag the problem throw an
